                    ...
                    <div class="col-12">
                      <div class="table-responsive">
                        <table id="order-listing" class="table">
                          ...
                          <?php
                          $no= 1;
                          $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_m_supplier order by fld_id_supplier desc");
                          while($data = mysqli_fetch_array($tampil)):
                          ?>
                          <tbody>
                            <tr>
                                <td class = "text-center"><?=$no++?></td>
                                <td class = "text-center"><?=$data['fld_id_supplier']?></td>
                                <td class = "text-center"><?=$data['fld_nama_supplier']?></td>
                                <td class = "text-center"><?=$data['fld_alamat_supplier']?></td>
                                <td class = "text-center"><?=$data['fld_telp_supplier']?></td>
                                <td>
                                  <a href="tambah_supplier.php?hal=edit&id=<?= $data['fld_id_supplier']?>" class="btn btn-outline-primary">Edit</a>
                                  <a href="tambah_supplier.php?hal=hapus&id=<?= $data['fld_id_supplier']?>" class="btn btn-outline-danger"
