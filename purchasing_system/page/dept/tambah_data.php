...
if (isset($_POST['simpan'])) {
    ...
    if(isset($_GET['hal'])=='edit') {
        // data akan diedit
        $edit=mysqli_query($koneksi,"UPDATE tbl_m_dept SET fld_nama_dept = '$_POST[nama_dept]' WHERE fld_id_dept = '$_GET[id]'");
        ...
        $simpan = mysqli_query($koneksi,"INSERT INTO tbl_m_dept (fld_nama_dept) VALUE ('$_POST[nama_dept]')");
...
if (isset($_GET['hal'])) {
    ...
    if ($_GET['hal'] == 'edit') {
        ...
        $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_m_dept WHERE fld_id_dept = '$_GET[id]' ");
        $data = mysqli_fetch_array($tampil);
        if($data){
            // jika data ditemukan, data ditampung ke variable
         
            $vnama_dept =$data['fld_nama_dept'];
            
        }
    }elseif ($_GET['hal']=="hapus") {
        // persiapan hapus data
        $hapus = mysqli_query($koneksi, "DELETE FROM tbl_m_dept WHERE fld_id_dept = '$_GET[id]'");
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="dept.php">Departemen</a></li>                
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method ="post">
                    <div class="form-group">
                      ...
                      <input type="number" name ="id_dept" value='<?=$vid?>' class="form-control" id="" placeholder="Otomatis akan terisi">
                    </div>
                    <div class="form-group">
                      <label for="">Nama Departemen</label>
                      <input type="text" name="nama_dept" value='<?=$vnama_dept?>'class="form-control" id="" placeholder="Nama Dept">
                    </div>
                    <button type="submit" class="btn btn-primary me-2" name="simpan">Submit</button>
                    <a href="dept.php" class="btn btn-light">Kembali</a>
                  </form>
                </div>
              </div>
            </div>
