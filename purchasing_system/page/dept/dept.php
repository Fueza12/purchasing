            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="tambah_data.php" class="btn btn-primary btn-sm mb-3" >Tambah data</a>
                  <div class="row">
                    <div class="col-12">
                      <div class="table-responsive">
                        <table id="order-listing" class="table">
                          ...
                          <?php
                          $no= 1;
                          $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_m_dept order by fld_id_dept desc");
                          while($data = mysqli_fetch_array($tampil)):
                          ?>
                          <tbody>
                            <tr>
                                <td class ='text-center'><?= $no++?></td>
                                <td class ='text-center'><?= $data['fld_id_dept']?></td>
                                <td class ='text-center'><?= $data['fld_nama_dept']?></td>
                                <td class ='text-center'>
                                  <a href="tambah_data.php?hal=edit&id=<?= $data['fld_id_dept']?>" class="btn btn-outline-primary">Edit</a>
                                  <a href="tambah_data.php?hal=hapus&id=<?= $data['fld_id_dept']?>" class="btn btn-outline-danger"
