            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="tambah_Items.php" class="btn btn-primary btn-sm mb-3" >Tambah data</a>
                  <div class="row">
                    <div class="col-12">
                        ...
                        <table id="order-listing" class="table">
                          <thead>
                            <tr>
                                ...
                                <th class='text-center'>Kode Items </th>
                                <th class='text-center'>Nama Items</th>
                                <th class='text-center'>Supplier</th>
                                <th class='text-center'>Kategori</th>
                                <th class='text-center'>Satuan</th>
                                <th class='text-center'>Merek Items</th>
                          ...
                          $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_m_items
                                                            ...
                                                            ORDER BY tbl_m_items.fld_id_items
                                                            desc");
                          ...
                          <tbody>
                            <tr>
                                ...
                                <td class='text-center'><?=$data['fld_id_items']?></td>
                                <td class='text-center'><?=$data['fld_nama_items']?></td>
                                <td class='text-center'><?=$data['fld_nama_supplier']?></td>
                                <td class='text-center'><?=$data['fld_nama_kategori']?></td>
                                <td class='text-center'><?=$data['fld_satuan_items']?></td>
                                <td class='text-center'><?=$data['fld_tipe_items']?></td>
                                <td class='text-center'><?=$data['fld_merk_items']?></td>
                               
                                <td>
                                  <a href="tambah_items.php?hal=edit&id=<?= $data['fld_id_items']?>" class="btn btn-outline-primary">Edit</a>
                                  <a href="tambah_items.php?hal=hapus&id=<?= $data['fld_id_items']?>" class="btn btn-outline-danger"
                                  onclick="return confirm('Apakah data akan di Hapus?')">Hapus</a>
                                </td>
                            </tr>
                            <?php endwhile;?>
