...
if (isset($_POST['simpan'])) {
    ...
    if(isset($_GET['hal'])=='edit') {
        // data akan diedit
        $edit=mysqli_query($koneksi,"UPDATE tbl_m_items SET fld_nama_items = '$_POST[nama_items]',
                                                               fld_id_supplier = '$_POST[nama_supplier]',
                                                               fld_id_kategori = '$_POST[nama_kategori]',
                                                               fld_satuan_items = '$_POST[satuan_items]',
                                                               fld_tipe_items = '$_POST[tipe_items]',
                                                               fld_merk_items = '$_POST[merk_items]'
                                     WHERE fld_id_items = '$_GET[id]'");
        ...
        $simpan = mysqli_query($koneksi,"INSERT INTO tbl_m_items (fld_nama_items,fld_id_supplier,fld_id_kategori,fld_satuan_items,fld_tipe_items, fld_merk_items) VALUE (
                                                                                                                                     '$_POST[nama_items]',
                                                                                                                                     '$_POST[nama_supplier]',
                                                                                                                                     '$_POST[nama_kategori]',
                                                                                                                                     '$_POST[satuan_items]',
...
if (isset($_GET['hal'])) {
    ...
    if ($_GET['hal'] == 'edit') {
        ...
        $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_m_items
                                                            INNER JOIN tbl_m_supplier ON tbl_m_items.fld_id_supplier = tbl_m_supplier.fld_id_supplier
                                                            INNER JOIN tbl_m_kategori ON tbl_m_items.fld_id_kategori= tbl_m_kategori.fld_id_kategori
                                                            WHERE fld_id_items = '$_GET[id]' ");
        $data = mysqli_fetch_array($tampil);
        if($data){
            // jika data ditemukan, data ditampung ke variable
         
            $vnama_items =$data['fld_nama_items'];
            $vnama_supplier = $data['fld_nama_supplier'];
            $vnama_kategori = $data['fld_nama_kategori'];
            $vsatuan_items = $data['fld_satuan_items'];
            $vmerk_items=$data['fld_merk_items'];
            $vtipe_items=$data['fld_tipe_items'];
            
        }
    }elseif ($_GET['hal']=="hapus") {
        // persiapan hapus data
        $hapus = mysqli_query($koneksi, "DELETE FROM tbl_m_items WHERE fld_id_items = '$_GET[id]'");
...
<body class="sidebar-dark">
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="../../page/supplier/supplier.php">Supplier</a></li>
      ...
      <!-- partial -->
      <!-- <?php
      $sql= mysqli_query($koneksi, "SELECT * FROM tbl_m_items, tbl_m_supplier, tbl_m_kategori
                                    WHERE tbl_m_items.fld_id_supplier=tbl_m_supplier.fld_id_supplier,
                                          tbl_m_items.fld_id_kategori=tbl_m_kategori.fld_id_kategori AND fld_id_items = '$_GET[edit]' ");
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method='post'>
                    <div class="form-group">
                      ...
                      <input type="number" name='id_items' value='<?=$vid?>' class="form-control" id="" placeholder="Otomatis akan terisi">
                    </div>
                    <div class="form-group">
                      <label for="">Nama Items</label>
                      <input type="text" name='nama_items' value='<?=$vnama_items?>' class="form-control" id="" placeholder=".....">
                    </div>
                    <div class="form-group">
                      <label for="">Supplier</label>
                      <input type="text" name='nama_supplier' value='<?=$vnama_supplier?>' class="form-control" id="" placeholder=".....">
                      <!-- <select name="nama_supplier" id="" class="form-control" value="<?=$vnama_supplier?>">
                        <option value="<?=$vnama_supplier?>"></option>
                      </select> -->
                    </div>
                    <div class="form-group">
                      <label for="">Kategori</label>
                      <input type="text" name='nama_kategori' value='<?=$vnama_kategori?>' class="form-control" id="" placeholder=".....">
                    </div>
                    <div class="form-group">
                      <label for="">Satuan</label>
                      <input type="text" name='nama_satuan' value='<?=$vsatuan_items?>' class="form-control" id="" placeholder=".....">
                    </div>
                    <div class="form-group">
                      <label for="">Merek Items</label>
                      <input type="text" name='merk_items' value='<?=$vmerk_items?>' class="form-control" id="" placeholder=".....">
                    </div>
                    <div class="form-group">
                      <label for="">Tipe</label>
                      <input type="text" name='tipe_items' value='<?=$vtipe_items?>' class="form-control" id="" placeholder=".....">
                    </div>
                    <button type="submit" class="btn btn-primary me-2" name="simpan">Submit</button>
                    <a href="items.php" class="btn btn-light">Kembali</a>
                  </form>
                </div>
              </div>
            </div>
