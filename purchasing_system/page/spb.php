            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">SURAT PERMINTAAN BARANG</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="mb-3"><label for="exampleFormControlInput1">Email address</label><input class="form-control form-control" id="exampleFormControlInput1" type="email" placeholder="name@example.com"></div>
                                </form>
                            </div>
                        </div>
                        <div class="card mb-4">
