...
if (isset($_POST['simpan'])) {
    ...
    if(isset($_GET['hal'])=='edit') {
        // data akan diedit
        $edit=mysqli_query($koneksi,"UPDATE tbl_m_kategori SET fld_nama_kategori = '$_POST[nama_kategori]' WHERE fld_id_kategori = '$_GET[id]'");
        ...
        $simpan = mysqli_query($koneksi,"INSERT INTO tbl_m_kategori (fld_nama_kategori) VALUE ('$_POST[nama_kategori]')");
...
if (isset($_GET['hal'])) {
    ...
    if ($_GET['hal'] == 'edit') {
        ...
        $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_m_kategori WHERE fld_id_kategori = '$_GET[id]' ");
        ...
        $hapus = mysqli_query($koneksi, "DELETE FROM tbl_m_kategori WHERE fld_id_kategori = '$_GET[id]'");
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method='post'>
                    <div class="form-group">
                      ...
                      <input type="number" name ="id_kategori" value='<?=$vid?>' class="form-control" id="" placeholder="Otomatis akan terisi">
                    </div>
                    <div class="form-group">
                      <label for="">Nama Kategori</label>
                      <input type="text" name ="nama_kategori" value='<?=$vnama_kategori?>' class="form-control" id="" placeholder="Nama Kategori">
                    </div>
                  
                    <button type="submit" class="btn btn-primary me-2" name="simpan">Submit</button>
                    <a href="kategori.php" class="btn btn-light">Kembali</a>
                  </form>
                </div>
              </div>
            </div>
