            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="tambah_kategori.php" class="btn btn-primary btn-sm mb-3" >Tambah data</a>
                  <div class="row">
                    <div class="col-12">
                      <div class="table-responsive">
                        <table id="order-listing" class="table">
                          ...
                          <?php
                          $no= 1;
                          $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_m_kategori order by fld_id_kategori desc");
                          while($data = mysqli_fetch_array($tampil)):
                          ?>
                          <tbody>
                            <tr>
                                <td class ='text-center'><?= $no++?></td>
                                <td class ='text-center'><?= $data['fld_id_kategori']?></td>
                                <td class ='text-center'><?= $data['fld_nama_kategori']?></td>
                                <td class ='text-center'>
                                  <a href="tambah_kategori.php?hal=edit&id=<?= $data['fld_id_kategori']?>" class="btn btn-outline-primary">Edit</a>
                                  <a href="tambah_kategori.php?hal=hapus&id=<?= $data['fld_id_kategori']?>" class="btn btn-outline-danger"
